...
// WH SelfInvest introduces the account onto IBKR's Client Portal, served from
// clientam.com just like MEXEM and Captrader, so the same portal bridge is used.
...
// Field 7183 is the order-ticket "Trading Restricted" notice. WH SelfInvest
// shows it as: "Trading Restricted — This product does not have a KID in
// English or in a language approved for your country. Retail clients can trade
// packaged retail products only if an appropriate KID is available." 7184 alone
// is not enough: tradable UCITS listings also come back with 7184=1.
