...
// / FTT come from the T212 map. Custody on the BSE / Deutsche Börse pages
...
export function roundTripCost({
  ...
  if (!catalogue) {
    return {
      ...answer,
      why: "le catalogue EFOCS n'existe pas encore : lancer `node efocs/efocs.mjs`",
    };
  }
  ...
  const bookUsd = dollars(marketPerShare ?? 0, listing.currency) ?? 0;
